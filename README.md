...
## ✅ Video Output
<video src="[YOUR_UPLOADED_VIDEO_URL_HERE](https://github.com/user-attachments/assets/f4257bf1-7fc3-4359-80a7-a1be0828553b)" width="100%" controls>
...
You can run any python script from script folder.

🎈 I recommed to modify the code and play with it 😁.

🏃‍♂️Use this command for running the python script: `rosrun sr1 'python file name'.py`
